...
def make(option: Option, timestamp: str) -> str:
    ...
    blocked_domains: Set[str] = option.blockedDomains
    return f'''\
"""
...
ALLOWED_HEADERS: Set[str] = {allowed_headers}
HEADER_OVERRIDES: Dict[str, str] = {header_overrides}
BLOCKED_DOMAINS: Set[str] = {blocked_domains}
...
def isBlockedDomain(domain: str) -> bool:
    return ('none' not in BLOCKED_DOMAINS) and (('all' in BLOCKED_DOMAINS) or (domain in BLOCKED_DOMAINS))
'''